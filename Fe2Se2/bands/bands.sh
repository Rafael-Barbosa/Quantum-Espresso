...
mpirun -np 8 pw.x < $system.scf.in > $system.scf.out
...
mpirun -np 8 pw.x < $system.bands.in > $system.bands.out
...
mpirun -np 8 bands.x < $system.bands-up-plot.in > $system.bands-up-plot.out
...
mpirun -np 8 bands.x < $system.bands-dw-plot.in > $system.bands-dw-plot.out
